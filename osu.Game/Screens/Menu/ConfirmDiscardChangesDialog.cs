...
namespace osu.Game.Screens.Menu
{
    public partial class ConfirmDiscardChangesDialog : PopupDialog
    {
        ...
        {
            HeaderText = ConfirmDiscardChangesDialogStrings.HeaderTitle;
            BodyText = ConfirmDiscardChangesDialogStrings.BodyText;
            ...
            Buttons = new PopupDialogButton[]
            {
                ...
                {
                    Text = ConfirmDiscardChangesDialogStrings.Cancel,
                    Action = onCancel
                },
            };
        }
